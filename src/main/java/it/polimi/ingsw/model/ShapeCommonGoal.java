...
public class ShapeCommonGoal extends CommonGoal implements Serializable {
    ...
    /**
     * This method checks if the starting coordinate and the offsets in the ruleShape list are within the bounds of the bookshelf.
     *
     ...
     * @return {@code True} if an element with indexes (i,j), added to the corresponding array of the list incrementRuleShape
     * @see #ruleShape
     */
    ...
    /**
     * This is a support method used to help in the search of the commonGoal grouped in this class.
     *
    ...
    /**
     * Method used to check if Starting at the index of the bookshelf (row, column)
     * <br>
     * we have a CommonGoal of the one grouped in this class or not.
     *
     * @param row       The index of the Row
     * @param column    The index of the Column
     * @param candidate A shape of the one grouped in this class to be achieved
     * @return {@code True} if the CommonGoal is Achieved
    ...
    /**
     * <p>
     * Boolean method to check if the initial coordinate allows a commomGoal or not.
     * We can make this simple control just by comparing the possibility to have a
     * commonGoal of the one we check with this class and the size of the bookshelf.
     * </p>
     *
     ...
     * @return {@code True} If an element with index row, column is part of the bookshelf
     * and {@code False} Otherwise.
     */
