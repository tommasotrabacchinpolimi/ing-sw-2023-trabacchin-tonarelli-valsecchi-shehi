 ...
 * @since 21/04/2023
 */
public class TupleCommonGoal_altt extends CommonGoal implements Serializable {
     ...
     * @see CommonGoal#CommonGoal()
     */
    public TupleCommonGoal_altt(int groupsNumber, int adjacentTilesPo2, boolean square, boolean separated, boolean sameTypeOnly) {
        super();
     ...
     */
    public TupleCommonGoal_altt(String description, String id, int groupsNumber, int adjacentTilesPo2, boolean square, boolean separated, boolean sameTypeOnly) {
     ...
     */
    public TupleCommonGoal_altt(Stack<Integer> scoringTokens, String description, String id, int groupsNumber, int adjacentTilesPo2, boolean square, boolean separated, boolean sameTypeOnly) {
    ...
    /**
     * The method returns {@code null} if the {@link TupleCommonGoal_altt} is not satisfied for
     * the {@code bookShelf} passes as argument.
     * If the {@link TupleCommonGoal_altt} is satisfied then the method returns the list of the
     * {@link EntryPatternGoal EntryPatternGoal} representing
     * the cell in the <code>bookShelf</code> that satisfy the {@link TupleCommonGoal_altt TupleCommonGoal}.
     *
     ...
     *
     * @return a {@link String} representing the {@link TupleCommonGoal_altt}.
