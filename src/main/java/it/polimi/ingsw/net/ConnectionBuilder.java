...
public class ConnectionBuilder {
    ...
    public static <L extends RemoteInterface, R extends RemoteInterface> RmiConnectionManager<L,R> buildRmiConnection(String host, int portNumber, TypeToken<R> remoteTargetClass, TypeToken<L> localTargetClass, L localTarget, ExecutorService executorService) throws IOException, NotBoundException, ClassNotFoundException {
