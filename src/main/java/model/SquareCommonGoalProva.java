...
public class SquareCommonGoalProva extends CommonGoal implements Serializable {
    ...
    public static void main(String[] args){
        ...
        SquareCommonGoalProva squareCommonGoalProva = new SquareCommonGoalProva(2,1,true,"");
        System.out.println(squareCommonGoalProva.rule(bookShelf).size());
    }
        ...
        private final boolean noAdj;


        public SquareCommonGoalProva(int groupsNumber, int squareDimPo2, boolean noAdj, String description){
            super(description);
        ...
        public void setSquareDim(int squareDimPo2) {
            this.squareDimPo2 = squareDimPo2;
        }
